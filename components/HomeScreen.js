            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.horizontalScroll}>
              {trendingMovies.map((movie) => (
                <View key={movie.id} style={styles.card}>
                  ...
                  <TouchableOpacity style={styles.downloadBtn} onPress={() => openDetails({ ...movie, overview: 'Película destacada de la fase 1.' })}>
                    <Text style={{ color: '#fff', fontSize: 12 }}>Ver detalle</Text>
                  </TouchableOpacity>
                </View>
              ))}
            </ScrollView>
